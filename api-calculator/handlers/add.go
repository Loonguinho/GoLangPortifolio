...
func AddHandler(w http.ResponseWriter, r *http.Request,  logger *slog.Logger) {
	...
	result := num1 + num2
	logger.Info("Addition result", slog.Float64("a", num1), slog.Float64("b", num2), slog.Float64("result", result))
